...
#下面中括号的地方需要要填你的包名
#-keep public class [com.wd.health].R$*{
...
# for DexGuard only
#-keepresourcexmlelements manifest/application/meta-data@value=WDHEALTH
