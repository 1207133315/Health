...
public class DoctordetailBean {
    ...
    private List<DoctorReceiveGiftList> doctorReceiveGiftList;
    ...
    public List<DoctorReceiveGiftList> getDoctorReceiveGiftList() {
        return doctorReceiveGiftList;
    }

    public void setDoctorReceiveGiftList(List<DoctorReceiveGiftList> doctorReceiveGiftList) {
        this.doctorReceiveGiftList = doctorReceiveGiftList;
    }
    public static class DoctorReceiveGiftList{
        private int worth;
