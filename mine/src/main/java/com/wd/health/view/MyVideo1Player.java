...
public class MyVideo1Player extends JZVideoPlayerStandard {
    private RelativeLayout rl_touch_help;
    private ImageView iv_start;
    private LinearLayout ll_start;
    public  static MyVideo1Player myVideoPlayer;
    private Context context;


    public MyVideo1Player(Context context) {
        super(context);
        this.context = context;
        myVideoPlayer = this;
    }

    public MyVideo1Player(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
